...
AlternateBedRoom.prototype =
{
	...
	create: function()
	{
		...
		this.closet = game.add.sprite(90, 38, 'closet_~');
...
Backyard.prototype =
    {
        create: function () {
            ...
            this.tree = game.add.sprite(352, 0, 'tree');
            this.appleTrigger = game.add.sprite(379, 120, 'trigger');
            this.appleTrigger.scale.setTo(0.2, 0.2);
            this.appleTrigger.alpha = 0.0;
            ground = game.add.group();
			ground.enableBody = true;

			this.backyard_ground = ground.create(0, 129, 'backyard_ground');
			this.backyard_ground.body.immovable = true;
			this.backyard_cement_ground = ground.create(0, 126, 'backyard_cement_ground');
            ...
            this.apple = game.add.sprite(368, 73, 'apple');
